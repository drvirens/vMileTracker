...
#import "VSGeolocationPickerCell.h"
...
@interface VSGeolocationPickerCell () <MKMapViewDelegate, VSGeolocationPickerViewDelegate>
@end

@implementation VSGeolocationPickerCell
