...
#define DEFAULT_FONT_SIZE 12.0 //viren
...
- (void)setupDefaultAppearence{
  ...
  [self setChartBackgroundColor:[UIColor whiteColor] ];
		//viren-
...
//  [self setElementStrokeColor:[UIColor colorWithRed:1 green:1 blue:1 alpha:1]];
	[self setLineColor:[VSBranding themeColor]];
	[self setElementFillColor:[VSBranding themeColor]];
	[self setElementStrokeColor:[VSBranding themeColor]];
...
//  [self setGridIntervalFont:[UIFont fontWithName:@"HelveticaNeue" size:DEFAULT_FONT_SIZE]];
	[self setGridIntervalLinesColor:[UIColor clearColor]];
	[self setGridIntervalFontColor:[UIColor clearColor]];
	[self setGridIntervalFont:[UIFont fontWithName:@"HelveticaNeue" size:DEFAULT_FONT_SIZE]];
		//vire-
